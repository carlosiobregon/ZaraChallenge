//
//  CharacterEpisodeCollectionCellViewModel.swift
//  ZaraChallenge
//
...
final class CharacterEpisodeCollectionCellViewModel: Hashable, Equatable {
    ...
    static func == (lhs: CharacterEpisodeCollectionCellViewModel, rhs: CharacterEpisodeCollectionCellViewModel) -> Bool {
